...
function Home() {
  return (
    <>
      <div className="container w-16 lg:w-20 lg:h-40 h-32 flex flex-col gap-y-2 justify-center fixed transform bottom-32">
        {/* Social Media Link */}
        <div className="border-2 bg-fuchsia-100 h-1/2 rounded-e-lg flex justify-center items-center">
          {/* Instagram */}
          <svg
        ...
        <div className="border-2 bg-indigo-100 h-1/2 rounded-e-lg flex justify-center items-center">
          {/* Email */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
